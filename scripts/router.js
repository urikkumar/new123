define([
    ...
    'views/ganttv4'
        ...
        jqgrid, jquery_ui, login, nestable_list, pricing, profile, tables, timeline, treeview, widgets, wysiwyg, error_500, ganttv1, ganttv2, ganttv3, ganttv4) {
        ...
        var initialize = function(){
            ...
            app_router.on('route:showganttv4', function(){
               
                // Call render on the module we loaded in via the dependency array
                var ganttv4view = new ganttv4();
                ganttv4view.render();
